...
namespace Sprint_4
{
    ...
    public class FloorBlockEntity: BlockEntity
    {
      ...
      //  private BlockChanging blockChanging;
        ...
        //Method begin.
        public FloorBlockEntity(SpriteFactory spriteFactory, Vector2 Position) : base (spriteFactory, Position)
        {
          ...
          //  blockChanging = new BlockChanging(this);
            Sprite = spriteFactory.createBlock(SpriteFactory.sprites.floorBlock);
