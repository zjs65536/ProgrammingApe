...
namespace Sprint_4
{
    ...
    public class StairBlockEntity: BlockEntity
    {
      ...
      //  private BlockChanging blockChanging;
        ...
        //Method begin.
        public StairBlockEntity(SpriteFactory spriteFactory, Vector2 Position) : base (spriteFactory, Position)
        {
          ...
          //  blockChanging = new BlockChanging(this);
            Sprite = spriteFactory.createBlock(SpriteFactory.sprites.stairBlock);
