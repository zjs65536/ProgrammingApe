...
namespace Sprint_4
{
    class flagpole : IBlock
    {
        ...
        public flagpole(GraphicsDevice graphicsDevice, Texture2D texture, bool showBox)
        {
            Texture = texture;
        ...
        {
            return new Rectangle((int)location.X + 24, (int)location.Y, Texture.Width - 36, Texture.Height);
        }
